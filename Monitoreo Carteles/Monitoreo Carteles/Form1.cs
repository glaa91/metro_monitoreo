...
namespace Monitoreo_Carteles
{
    public partial class Form1 : Form
    {
        ...
        private List<Usuario> usuarios_l = new List<Usuario>();
        private List<Cartel> carteles_l = new List<Cartel>();
        private List<Estacion> estaciones_l = new List<Estacion>();
        ...
        public Form1()
        {
            ...
            var cadena = "Server=190.16.226.7;Port=5432;User Id=postgres;Password=postgres;Database=scp;";
            ...
            if (!string.IsNullOrWhiteSpace(cadena))
            {
                ...
                {
                    MessageBox.Show("Conexion a la base de datos: ERROR");
                    conexion.Close();
                }
            }
